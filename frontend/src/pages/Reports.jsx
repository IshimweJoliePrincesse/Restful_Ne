...
// Supported report types match backend report endpoints.
const reportTypes = ['inventory', 'inspection', 'compliance', 'maintenance'];

export default function Reports() {
  // Report queries are disabled until the user explicitly generates each report.
  ...
  // Generate action runs the selected report query on demand.
  ...
  // Export action opens CSV/PDF downloads with the current token for authorization.
  ...
  // Page render displays one report card per report type with generate/export actions.
  return (
    <div>
